...
-- Set spelling dictionary - commented out for now to try the automated name generation
-- vim.opt.spellfile=vim.fn.expand("~/.config/nvim-notes/spell/en.utf-8.add")
